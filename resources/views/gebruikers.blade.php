...
<div style="min-height: 100vh" class="flex">
    <div id="sidebar" class="dashboard-sidebar w-1/5 shadow-lg lg:block hidden">
        <div class="flex flex-col">
            <div class="p-5 border-primary">
                <a class="flex justify-center" href="#"><img class="w-40" src="{{URL::asset('/img/LogoGV-Zwart.png')}}"/></a>
            </div>
            <div class="p-5">
                <div>
                    <div><a class="flex items-center pb-3 font-bold active-dashboard" href="#!"><img class="pr-2" style="height: 13px;" src="{{URL::asset('/img/home-icon-silhouette.png')}}" />Dashboard</a></div>
                    ...
                    <div><a class="flex items-center pb-3 font-bold" href="#!"><img class="pr-2" style="height: 13px;" src="{{URL::asset('/img/news.png')}}" />Nieuwsberichten</a></div>
